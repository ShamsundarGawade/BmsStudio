...
namespace Peak.Can.IsoTp
{
    ...
    public enum cantp_status : UInt32
    {
        ...
        /// </summary>
        PCANTP_STATUS_MASK_PCAN = 0x80000000U,
        #endregion
    }
    ...
    public enum cantp_can_msgtype : UInt32
    {
        ...
        /// <summary>
        /// The PCAN message represents a self-received (Tx-loopback) message
        /// </summary>
    ...
    public struct cantp_msg
    {
        ...
        /// Or with unsafe {_data.ToPointer()}
        /// See special C# functions
        /// </summary>
        private IntPtr msgdata;
        /// <summary>
        /// get _data field as a property
        /// </summary>
        ...
        /// <summary>
        /// get _data field as a cantp_msgdata property
        /// The fields of this property will not be writable except (not directly) those whose type is "IntPtr".
        /// Before using this property, check if _data is not IntPtr.Zero
        /// </summary>
        ...
        /// <summary>
        /// get _data field as a cantp_msgdata_can property
        /// The fields of this property will not be writable except (not directly) those whose type is "IntPtr".
        /// Before using this property, check if _data is not IntPtr.Zero
        /// </summary>
        ...
        /// <summary>
        /// get _data field as a cantp_msgdata_canfd property
        /// The fields of this property will not be writable except (not directly) those whose type is "IntPtr".
        /// Before using this property, check if _data is not IntPtr.Zero
        /// </summary>
        ...
        /// <summary>
        /// get _data field as a cantp_msgdata_isotp property
        /// The fields of this property will not be writable except (not directly) those whose type is "IntPtr".
        /// Before using this property, check if _data is not IntPtr.Zero
        /// </summary>
...
#if (UNSAFE)
        /// <summary>
        /// get the _data field as a pointer to cantp_msgdata 
        ...
        /// <summary>
        /// get the _data field as a pointer to cantp_msgdata_isotp 
        /// all fields of this property will be writable (in unsafe mode) since it is a pointer.
        /// Before using this property, check if _data is not IntPtr.Zero
        /// </summary>
